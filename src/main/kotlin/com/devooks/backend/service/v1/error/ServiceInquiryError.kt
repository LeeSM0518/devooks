...
enum class ServiceInquiryError(val exception: GeneralException) {
    ...
    REQUIRED_SERVICE_INQUIRY_ID(GeneralException("SERVICE-400-5", HttpStatus.BAD_REQUEST, "서비스 문의 식별자가 반드시 필요합니다.")),
    INVALID_SERVICE_INQUIRY_ID(GeneralException("SERVICE-400-6", HttpStatus.BAD_REQUEST, "잘못된 형식의 서비스 문의 식별자입니다.")),
